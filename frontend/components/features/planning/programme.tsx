...
export function PlanningProgramme({ embedded = false }: { embedded?: boolean } = {}) {
  ...
  if (embedded) {
    return <div className="space-y-8">{planningMainContent}</div>;
  }
